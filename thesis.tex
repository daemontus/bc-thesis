  ...
  \MainMatter                     % The main matter
    ...
    \chapter{Algorithm}
    	...
    	\section{Common operations}
			...
			Symetrically, $successors : S \rightarrow S \times 2^\mathcal{P} $ computes set of direct successors of given node including the color sets labeling the appropriate transitions.
